...
customers = Customer.create([{firstname: 'Jean', lastname: 'Dupont', email: 'dupont@laposte.net', password_digest: 'allerlesbleus', username: 'Dupont'},{firstname: 'Randy', lastname: 'Marsh', email: 'randy@southpark.com', password_digest: 'cremefraiche', username: 'Falcorn'}])
